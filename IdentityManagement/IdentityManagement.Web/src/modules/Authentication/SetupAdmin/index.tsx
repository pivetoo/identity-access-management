                ...
                {info && (
                  <div className="flex flex-col gap-2 mb-6 p-4 rounded-lg bg-primary/5 border border-primary/10">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-muted-foreground">{t('authentication.setupAdmin.label.system')}:</span>
                      <span className="font-medium text-foreground">{info.systemApplicationName}</span>
                    </div>
                  </div>
                )}
