...
namespace IdentityManagement.Application.Services
{
    ...
    {
        Task<string> GenerateAccessToken(User user, Contract contract, int lifetimeSeconds, string sessionId, string clientId, CancellationToken cancellationToken = default);
